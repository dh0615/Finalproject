...
// css에서 애니메이션 효과가 시작되는 타이밍에 이벤트를 실행시키려면 animationstart라는 이벤트 핸들러
// css에서 애니메이션 효과의 반복이 시작되는 타이밍에서는 animationiteration이라는 이벤트 핸들러 !!
// css에서 애니메이션 효과가 종료되는 타이밍에서는 animationend라는 이벤트 핸들러가 작동
